...
<?php foreach($themes as $t) { ?>
            <li><a href="<?php echo get_term_link($t->name, 'theme'); if(isset($_GET['view']) && $_GET['view']=='list') { echo '?view=list'; } ?>"><?php echo $t->name; ?></a></li>
<?php } ?>
            <li class="featured">By Type
              <ul>
<?php foreach($types as $t) { ?>
            <li<?php if($t->term_id == $term->term_id) { echo ' class="catActive"'; } ?>><a href="<?php echo get_term_link($t->name, 'type'); if(isset($_GET['view']) && $_GET['view']=='list') { echo '?view=list'; } ?>"><?php echo $t->name; ?></a></li>
<?php } ?>          
              </ul>
            </li>
